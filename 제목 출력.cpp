...
{
	printf("\n\n\n\n"); // 맨위에 4칸 개행  
	printf("     OOOOOOOOOOO                   O               O                                                 \n");
	printf("               O      OOOOOOOOOOO  O    OOOOOOOOO  O                                                                           \n");
	printf("               O           O       O    O       O  O                                                 \n");
	printf("    OOOOOOOOOOOOOO        O O      O    O       O  O                                                          \n");
	printf("           O             O   O     O    O       O  OOOO                                                          \n");
	printf("     OOOOO0 OOOOO       O     O    O    O       O  O                                      \n");
	printf("          0 O   O      O       O   O    O       O  O                                                      \n");
	printf("     OOOOOO O   O     O         O  O    OOOOOOOOO  O                                                        \n");
	printf("     O      O   O                  O               O                                                          \n");
	printf("     OOOOOO OOOOO                  O               O                                                            \n");
}
int menuDraw()
{
	int x = 24;
